...
/***/ function(module, exports, __webpack_require__) {
	...
	var BindingContext = (function (_React$Component) {
	  ...
	  BindingContext.prototype._update = function _update(mapValue, args) {
	    ...
	    if (false) updater = wrapSetter(updater);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Field = function (_React$Component) {
	  ...
	  Field.prototype.componentWillMount = function componentWillMount() {
	    ...
	    if (false) (0, _invariant2.default)(context.noValidate || !name || this.schema(name), 'There is no corresponding schema defined for this field: "' + name + '" ' + 'Each Field\'s `name` prop must be a valid path defined by the parent Form schema');
	  };
