...
con.connect(function(err) {
    ...
    con.query('CREATE TABLE IF NOT EXISTS SPONSORACCT (SUID int auto_increment NOT NULL unique,First_name varchar(20) NOT NULL,Last_name varchar(20) NOT NULL,Email varchar(20) NOT NULL,Password_hash varchar(255) NOT NULL,Password_salt varchar(60) NOT NULL,Address varchar(20) NOT NULL,Phone_number char(12) NOT NULL,VisibleFlag BIT NOT NULL,SID int NOT NULL,primary key (SUID),foreign key (SID) references SPONSORORG(SID));', function(error, result, fields) {
        console.log(result);
    });
    ...
    //Creates ADMIN Table
    con.query('CREATE TABLE IF NOT EXISTS ADMIN (A_ID int auto_increment NOT NULL unique,First_name varchar(20) NOT NULL,Last_name varchar(20) NOT NULL,Email varchar(20) NOT NULL,Password_hash varchar(255) NOT NULL,Password_salt varchar(60) NOT NULL,Address varchar(60) NOT NULL,Phone_number char(12) NOT NULL,VisibleFlag BIT NOT NULL,SID int NOT NULL,primary key (A_ID));', function(error, result, fields) {
        console.log(result);
    });

    //Creates PASSWORDCHANGES
    con.query('CREATE TABLE IF NOT EXISTS PASSWORDCHANGES (PwdChangeID int auto_increment NOT NULL unique,User_type varchar(20) NOT NULL,Pwd_date DATETIME NOT NULL,Email varchar(20) NOT NULL,Change_type varchar(20) NOT NULL,primary key (PwdChangeID));', function(error, result, fields) {
        console.log(result);
    });
    //CREATES LOGINATTEMPTS
    con.query('CREATE TABLE IF NOT EXISTS LOGINATTEMPTS (AttemptID int auto_increment NOT NULL unique,Login_date DATETIME NOT NULL,Username varchar(20) NOT NULL,Status varchar(20) NOT NULL,primary key (AttemptID));', function(error, result, fields) {
        console.log(result);
    });
    //CREATES REPORTING
    con.query('CREATE TABLE IF NOT EXISTS REPORTING (A_ID int auto_increment NOT NULL,PwdChangeID int NOT NULL,AttemptID int NOT NULL,foreign key (A_ID) references ADMIN(A_ID),foreign key (PwdChangeID) references PASSWORDCHANGES(PwdChangeID),foreign key (AttemptID) references LOGINATTEMPTS(AttemptID));', function(error, result, fields) {
        console.log(result);
    });

    //Creates CARTITEM Table
    con.query('CREATE TABLE IF NOT EXISTS CARTITEM (ItemID int auto_increment NOT NULL,ItemName varchar(255) NOT NULL,Price float NOT NULL,Quantity int NOT NULL,UID int NOT NULL,SID int NOT NULL,primary key (ItemID),foreign key (UID) references DRIVER(UID), foreign key (SID) references SPONSORORG(SID));', function(error, result, fields) {
        console.log(result);
    });
