...
SELECT * FROM SPONSORLISTINGS;
INSERT INTO SPONSORLISTINGS(ListingID, Title, Price, Quantity, Description, SID) VALUES(9223372036854775807,"COOL STUFF",12.38, 5, "SDJFKLSDJFLSDJFLSDJFLKSDJFLKSDJFLSDJFDS",2);
...
INSERT INTO SPONSORLISTINGS (ListingID, Title, Price, Quantity, Description, SID) VALUES (            12345678910,
            "NEW LISTING ITEM",
            14.99,
            3,
            "VERY COOL AND LONG DESCRIPTION FOR THIS NEW COOL ITEM IS VERY COOL IS VERY COOL",
            1);
            
ALTER TABLE SPONSORLISTINGS ADD COLUMN ImageURL varchar(1000) AFTER Description;